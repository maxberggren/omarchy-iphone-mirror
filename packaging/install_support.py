...
APP_FILES = ("mirror.py", "usb_input.py", "lifecycle.py", "connection.py", "cli.py", "local_feedback.py", "keyboard_layouts.py", "requirements.txt", "LICENSE", "THIRD_PARTY_NOTICES.md", "setup-phone.py", "phone_setup_agent.py")
